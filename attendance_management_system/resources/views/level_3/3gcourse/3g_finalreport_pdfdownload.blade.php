                ...
                <div>
                    <table style="width:100%; margin-top: 8%;">
                        <tr>
                            ...
                            <td><p class="t-left" style="color:#000080;"><b>Course Name: </b>@foreach($g3_cname as $g3cname) {{ $g3cname->course_name }} @endforeach</p></td>
                        </tr>
                        <tr>
                            <td><p class="t-left" style="color:#000080;"><b>Level: </b>3G</p></td>
                        ...
                        <tr>
                            <td><p class="t-left" style="color:#000080;"><b>Number of Lecture Hours: </b>{{ $g3_hourssum ." hours"}}</p></td>
                            @if(isset($from))
